...
<script src="<?php echo e(URL::asset('js/jquery-confirm.js')); ?>"></script>
<script src="<?php echo e(URL::asset('js/jquery.mask.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/locales/bootstrap-datepicker.pt-BR.min.js')); ?>"></script>
